...
const nodeFetch = __webpack_require__(360)
...
/* unused reexport */ __webpack_require__(341).serializeURL;
/* unused reexport */ __webpack_require__(341).serializeURLOrigin;
/* unused reexport */ __webpack_require__(341).basicURLParse;
/* unused reexport */ __webpack_require__(341).setTheUsername;
/* unused reexport */ __webpack_require__(341).setThePassword;
/* unused reexport */ __webpack_require__(341).serializeHost;
/* unused reexport */ __webpack_require__(341).serializeInteger;
/* unused reexport */ __webpack_require__(341).parseURL;
...
const { Argument } = __webpack_require__(998);
const { Command } = __webpack_require__(282);
const { CommanderError, InvalidArgumentError } = __webpack_require__(56);
const { Help } = __webpack_require__(917);
const { Option } = __webpack_require__(790);
...
const { InvalidArgumentError } = __webpack_require__(56);
...
const EventEmitter = (__webpack_require__(361).EventEmitter);
const childProcess = __webpack_require__(81);
const path = __webpack_require__(17);
const fs = __webpack_require__(147);
const process = __webpack_require__(168);

const { Argument, humanReadableArgName } = __webpack_require__(998);
const { CommanderError } = __webpack_require__(56);
const { Help } = __webpack_require__(917);
const { Option, splitOptionFlags, DualOptions } = __webpack_require__(790);
const { suggestSimilar } = __webpack_require__(812);
...
const { humanReadableArgName } = __webpack_require__(998);
...
var public_api = __webpack_require__(347);
;// CONCATENATED MODULE: external "https"
const external_https_namespaceObject = require("https");
;// CONCATENATED MODULE: external "zlib"
const external_zlib_namespaceObject = require("zlib");
;// CONCATENATED MODULE: ./node_modules/cross-fetch/node_modules/node-fetch/lib/index.mjs
...
;// CONCATENATED MODULE: ./node_modules/@ai-zen/node-fetch-event-source/lib/esm/parse.js
...
var node_ponyfill = __webpack_require__(165);
var node_ponyfill_default = /*#__PURE__*/__webpack_require__.n(node_ponyfill);
;// CONCATENATED MODULE: ./node_modules/@ai-zen/node-fetch-event-source/lib/esm/fetch.js
...
function fetchEventSource(input, _a) {
    var { signal: inputSignal, headers: inputHeaders, onopen: inputOnOpen, onmessage, onclose, onerror, fetch: inputFetch } = _a, rest = __rest(_a, ["signal", "headers", "onopen", "onmessage", "onclose", "onerror", "fetch"]);
    return new Promise((resolve, reject) => {
        ...
        const fetch = inputFetch !== null && inputFetch !== void 0 ? inputFetch : (node_ponyfill_default());
...
var commander = __webpack_require__(461);
...
function checkVersion() {
    const latestVersion = (0,external_child_process_.execSync)('npm view gptshell version --registry=http://registry.npmjs.org').toString().trim()
    if (compareVersions(package_namespaceObject.i8, latestVersion) == -1) {
